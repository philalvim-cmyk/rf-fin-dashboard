...
# ============================================================
# HELPERS (dirs / escrita atômica / validação de XLSX)
# ============================================================
...
def is_probably_xlsx(path: Path) -> Tuple[bool, str]:
    ...
    XLSX é um ZIP. Se não for ZIP válido, openpyxl pode falhar.
    """
    try:
        if not path.exists():
...
# ============================================================
# 5) IMPORTADOR 2025 (RESTAURADO + cloud-safe)
# ============================================================
st.divider()
...
# ============================================================
# 6) Gráficos (MVP) — sem “magic ternary”
# ============================================================
st.divider()
